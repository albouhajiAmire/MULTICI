              ...
              <div className="carousel-container">
                <div className="container">
                  ...
                  <p className="animate__animated animate__fadeInUp">
                    Transformez votre expérience client à chaque conversation
                  </p>
                  <a
                    href="#about"
            ...
            >
              <div className="carousel-container">
                <div className="container">
                  ...
                  <p className="animate__animated animate__fadeInUp">
                    Chaque interaction est une chance de renforcer la fidélité à
                    la marque de vos clients. Dépassez les attentes en proposant
                    des solutions connectées conçues pour générer de la valeur
